  ...
  return (
    <Transitions id="projects">
      <div id="projects-top-section" className="page-top-section">
        ...
        <h1>Scroll</h1>
        <ProjectBox imgPath="/assets/img/niveles.png" title="Niveles De Niveles" text={<>An early warning application that mitigate the consequences of natural disasters. This project made it to the finals of the XVII Concurso Nacional de Programación in Colombia. It is made with react-native with the use of websockets to provide aid to people in dsaster prone areas. The app is free and published to the App Store and Google Play store. Look at the website {<Hyperlink text={"here"} link={"https://nivelesdeniveles.org"}/>} or look at the code {<Hyperlink text={"here"} link={"https://github.com/NotARoomba/NivelesDeNiveles"}/>}.</>}/>
        ...
        <ProjectBox imgPath="/assets/img/asteroids.png" title="Asteroids" text={<>Another asteroids clone out of millions by aspiring developers to join their favorite game company by learning SDL, OpenGL, or any myriad of graphics libraries. Check it out on my website {<Hyperlink text={"here"} link={"https://asteroids.notaroomba.dev"}/>} or check out the releases {<Hyperlink text={"releases"} link={"https://github.com/NotARoomba/Asteroids/releases"}/>} to dodge asteroids with (somewhat) broken colision.</>}/>
        <ProjectBox imgPath="/assets/img/wordle.png" title="Wordle" text={<><s>A special product of desperation, boredom, and the desire to fit in comes this Cli version of the (decently) popular Wordle game.</s> After a few revisions now brings my version of Wordle to the web! It has more features and cool css wizardry. You can check it out online {<Hyperlink text={"here"} link={"https://wordle.notaroomba.dev"}/>} or you can look at the code {<Hyperlink text={"here"} link={"https://github.com/NotARoomba/Wordle"}/>}.</>}/>
        <ProjectBox imgPath="/assets/img/koombia.png" title="Koombia" text={<>Koombia lets you turn text from your science, spanish, history or ethics lessons into songs for you to memorize the contents of your quiz faster and easier. Using Koombia is as easy as copy, pasting, and clicking. Paste your lesson into the text area and select a genre for your song. It will generate a random beat with chord progressions based on the genre and a text to speech will sing the song. Next to it, theres a karaoke where you can test your singing skills and see if you learned correctly the song. You can try it out on my {<Hyperlink text={"website"} link={"https://koombia.notaroomba.dev"}/>} and look at the {<Hyperlink text={"GitHub"} link={"https://github.com/NotARoomba/Koombia"}/>}.</>}/>
        <ProjectBox imgPath="/assets/img/grindhub.png" title="GrindHub" text={<>GrindHub will help you turn your procrastination into your habits! We built an intuitive platform where you can challenge yourself and do different daily missions and receive rewards, that will help you increase your level! Using GrindHub will be fun and rewarding at the end of the year. You can try out this Ai mess {<Hyperlink text={"here"} link={"https://grindhub.notaroomba.dev"}/>} or look at the spaghetti code {<Hyperlink text={"here"} link={"https://github.com/NotARoomba/GrindHub"}/>}.</>}/>
        <ProjectBox imgPath="/assets/img/devoided.png" title="Devoided" text={<>Devoided is an RPG game that was developed in a hackathon and got 2nd place. The game is about a quantum engineer explores space-time in search of traces of a deck of ancient Earth, but in his search he becomes trapped in the past and future so he does everything possible to repair his time clock to return to the present and reunite. the letters to discover the mystery of the origin of the universe. You can try it out on my {<Hyperlink text={"website"} link={"https://devoided.notaroomba.dev"}/>} and look at the {<Hyperlink text={"GitHub"} link={"https://github.com/NotARoomba/Devoided"}/>}.</>}/>
        ...
        <ProjectBox imgPath="/assets/img/gravity.png" title="Gravity Simulator" text={<>Originally a gravity simulator made with Python then ported to C++ finally reaches the web browser! This simulation is powered by a rust WebAssembly backend that uses a naive implementation where all the bodies have gravittional force on eachother. There are plans to use the Barnes-Hut algorithim utilizing quadtrees to improve performance but for now the naive implementation works. You can try out this beautiful mess {<Hyperlink text={"here"} link={"https://gravity.notaroomba.dev"}/>} or look at the code {<Hyperlink text={"here"} link={"https://github.com/NotARoomba/Gravity-Simulator"}/>}.</>}/>
        <ProjectBox classN="red-roomba" imgPath="/assets/img/roomba.png" title="RoombaOS" text={<>A test operating system to learn Assembly and low level C. Planned feature include, porting Asteroids and WordleCLI, FAT filesystem, and some more commands. You can try out RoombaOS by downloading the binary from the {<Hyperlink text={"releases"} link={"https://github.com/NotARoomba/RoombaOS/releases"}/>} or look at the code {<Hyperlink text={"here"} link={"https://github.com/NotARoomba/RoombaOS"}/>}.</>}/>
    </Transitions>)
}