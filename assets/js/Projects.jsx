  ...
  return (
    <Transitions id="projects">
      <div id="projects-top-section" className="page-top-section">
        ...
        <ProjectBox imgPath="/assets/img/asteroids.png" title="Asteroids" text={<>Another asteroids clone out of millions by aspiring developers to join their favorite game company by learning SDL, OpenGL, or any myriad of graphics libraries. Check it out on my website {<Hyperlink text={"here"} link={"https://asteroids.notaroomba.xyz"}/>} or check out the releases {<Hyperlink text={"releases"} link={"https://github.com/NotARoomba/Asteroids/releases"}/>} to dodge asteroids with (somewhat) broken colision.</>}/>
        <ProjectBox imgPath="/assets/img/wordle.png" title="Wordle" text={<><s>A special product of desperation, boredom, and the desire to fit in comes this Cli version of the (decently) popular Wordle game.</s> After a few revisions now brings my version of Wordle to the web! It has more features and cool css wizardry. You can check it out online {<Hyperlink text={"here"} link={"https://wordle.notaroomba.xyz"}/>} or you can look at the code {<Hyperlink text={"here"} link={"https://github.com/NotARoomba/Wordle"}/>}.</>}/>
